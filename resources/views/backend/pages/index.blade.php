    ...
    <script>
        $(function() {
            var dataTable = $('#pages-table').dataTable({
                ...
                columns: [
                    {data: 'title', name: '{{config('access.page_table')}}.title'},
                    {data: 'status', name: '{{config('access.page_table')}}.status'},
                    {data: 'created_at', name: '{{config('access.page_table')}}.created_at'},
                    {data: 'updated_at', name: '{{config('access.page_table')}}.updated_at'},
